...
\begin{itemize}
  ...
  \item \textbf{Labor Market Signaling Theory}, introduced by Spence (1973), proposes that educational credentials function as indicators of a worker’s potential productivity. However, in rural settings where the volume or type of credentials may not align with regional labor market demands, the signaling mechanism can falter. This misalignment often results in credential mismatch, underemployment, and structural inefficiencies in the local workforce.
  
  \item \textbf{Rural Development and Digital Equity} provides a framework for understanding how structural, spatial, and technological barriers influence access to education and employment. Rural regions face unique challenges—including limited broadband access, inadequate public transportation, and geographic isolation—that constrain the effectiveness of traditional workforce development efforts. Applying a rural development lens highlights the importance of aligning educational strategies not only with skill development but also with infrastructure investment and equitable access (Whitacre et al., 2014; OECD, 2016).
\end{itemize}
