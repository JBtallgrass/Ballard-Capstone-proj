...
\subsection{8.1 Classification Goals and Methodology}
...
\subsection{8.2 Model Training and Evaluation Results}
...
\subsection{8.3 Confusion Matrix and Performance Summary}
...
\subsection{8.4 Feature Importance (Random Forest)}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{Capstone_Project_Report/images/feature_importance_rf.png}
...
\subsection{8.5 Visualizing the Decision Tree (Optional)}
