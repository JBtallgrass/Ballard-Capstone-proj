...
\subsection{Domain and Topic Selection}\label{subsec:domain_topic}
...
\subsection{The Data Problem}\label{subsec:data_prob}
...
\section{Regional and Theoretical Background}\label{sec:regional_theory}

\subsection{Overview of North Central Arkansas}\label{subsec:Overview_NCA}
\begin{figure}[H]
    \centering
...
\end{figure}
\subsubsection{Problem Context.}\label{subsec:Prob_context}
...
\subsubsection{Demographic and Economic Structure.}\label{subsec:demographic}
...
\subsection{Conceptual Framework}\label{subsec:conceptual_frame}
...
\section{Methodology: CRISP-DM Framework}\label{sec:CRISP-DM}
...
\clearpage
\bibliographystyle{splncs04}  % This is the default for LLNCS
