...
Nonetheless, the relatively small sample size of the NCA group may limit the power of these tests. Visualizations presented earlier (Sections~\ref{sec:eda_stripplots}–\ref{sec:eda_outliers}) show that several NCA counties exhibit distinct patterns—particularly on metrics of postsecondary attainment and economic distress. These findings directly informed the construction of composite vulnerability scores and binary classification flags described in Section~\ref{sec:feature_engineering}.
...
\label{appendix:data_dictionary}

\begin{table}[H]
\centering
\caption{Data Dictionary for Core Variables}
\label{tab:appendix_data_dictionary}
\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Variable} & \textbf{Description} \\
\midrule
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth, trim=20 20 20 20, clip]{Capstone_Project_Report/images/maps/nca_comparison_bachelorsdegreepct.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth, trim=20 20 20 20, clip]{Capstone_Project_Report/images/maps/nca_comparison_povertyrate.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth, trim=20 20 20 20, clip]{Capstone_Project_Report/images/maps/nca_comparison_vulnerabilityscore.png}
